...
layout: base.njk
title: Onyx Theme
description: Dark, editorial design theme
theme: onyx
---
...
<div class="section">
    <div class="container">
        ...
        <p style="font-size: 1.125rem; color: var(--color-text-secondary);">
            A dark, editorial theme with sophisticated typography and minimal borders. 
            Perfect for content-focused experiences that prioritize readability.
        </p>
    </div>
</div>
...
<div class="section" style="background-color: var(--color-bg-secondary);">
    <div class="container">
        <h2>Hero Section</h2>
        <div style="padding: var(--space-2xl); background: linear-gradient(135deg, var(--color-bg-primary) 0%, var(--color-bg-tertiary) 100%); border-radius: var(--radius-lg);">
            <h1 style="font-size: 3rem; margin-bottom: var(--space-md);">Editorial Excellence</h1>
            <p style="font-size: 1.25rem; color: var(--color-text-secondary); max-width: 600px;">
                Experience content in its purest form with the Onyx theme's sophisticated dark palette.
            </p>
...
document.addEventListener('DOMContentLoaded', function() {
    if (window.ThemeSwitcher) {
        window.ThemeSwitcher.setTheme('onyx');
    }
});
</script>
