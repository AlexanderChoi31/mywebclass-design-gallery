...
layout: base.njk
title: Brutal Theme
description: Brutalist, bold design theme
theme: brutal
---
...
<div class="section">
    <div class="container">
        ...
        <p style="font-size: 1.125rem; color: var(--color-text-secondary);">
            A brutalist design with sharp edges, bold typography, and high contrast. 
            Unapologetically bold and raw.
        </p>
    </div>
</div>
...
<div class="section" style="background-color: var(--color-bg-secondary);">
    <div class="container">
        <h2>Hero Section</h2>
        <div style="padding: var(--space-2xl); background: var(--color-bg-tertiary); border: 4px solid var(--color-border);">
            <h1 style="font-size: 3rem; margin-bottom: var(--space-md);">BRUTAL DESIGN</h1>
            <p style="font-size: 1.25rem; color: var(--color-text-primary); max-width: 600px; font-weight: bold;">
                NO COMPROMISES. NO DECORATION. JUST DESIGN.
            </p>
...
document.addEventListener('DOMContentLoaded', function() {
    if (window.ThemeSwitcher) {
        window.ThemeSwitcher.setTheme('brutal');
    }
});
</script>
