...
layout: base.njk
title: Neon Theme
description: High-contrast, modern design theme
theme: neon
---
...
<div class="section">
    <div class="container">
        ...
        <p style="font-size: 1.125rem; color: var(--color-text-secondary);">
            A high-contrast, modern theme with neon glow effects and bold colors. 
            Perfect for tech and gaming sites that want to stand out.
        </p>
    </div>
</div>
...
<div class="section" style="background-color: var(--color-bg-secondary);">
    <div class="container">
        <h2>Hero Section</h2>
        <div style="padding: var(--space-2xl); background: linear-gradient(135deg, var(--color-bg-primary) 0%, var(--color-bg-tertiary) 100%); border: 2px solid var(--color-accent); border-radius: var(--radius-md); box-shadow: 0 0 20px var(--color-accent);">
            <h1 style="font-size: 3rem; margin-bottom: var(--space-md); color: var(--color-accent);">Neon Future</h1>
            <p style="font-size: 1.25rem; color: var(--color-text-secondary); max-width: 600px;">
                Experience the future of web design with the Neon theme's vibrant glow effects.
            </p>
...
document.addEventListener('DOMContentLoaded', function() {
    if (window.ThemeSwitcher) {
        window.ThemeSwitcher.setTheme('neon');
    }
});
</script>
