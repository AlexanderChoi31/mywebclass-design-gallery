...
var require_abort_controller2 = __commonJS({
  "node_modules/airtable/lib/abort-controller.js"(exports2, module2) {
    ...
    var browserGlobal = typeof window !== "undefined" ? window : typeof self !== "undefined" ? self : null;
    if (!browserGlobal) {
      AbortController = require_abort_controller();
...
var require_airtable = __commonJS({
  "node_modules/airtable/lib/airtable.js"(exports2, module2) {
    ...
    module2.exports = Airtable;
  }
});

// _functions/submit.js
...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    if (process.env.AIRTABLE_API_KEY && process.env.AIRTABLE_BASE_ID && process.env.AIRTABLE_API_KEY !== "placeholder") {
      try {
        const Airtable = require_airtable();
    ...
    if (process.env.DISCORD_WEBHOOK_SUBMISSIONS) {
      try {
        const discordMessage = {
          content: "\u{1F4DD} New Form Submission",
          embeds: [
            {
              ...
              fields: [
                ...
                { name: "Message", value: message.substring(0, 1e3) },
